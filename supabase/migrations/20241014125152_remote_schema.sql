...
ALTER TABLE "public"."products" ALTER COLUMN "asin" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."products_asin_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
GRANT ALL ON SEQUENCE "public"."products_asin_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."products_asin_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."products_asin_seq" TO "service_role";
